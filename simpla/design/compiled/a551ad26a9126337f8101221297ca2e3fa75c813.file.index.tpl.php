<?php /* Smarty version Smarty-3.0.7, created on 2018-02-07 23:00:01
         compiled from "simpla/design/html\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:234075a7b5ac1463c67-76115775%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '234075a7b5ac1463c67-76115775',
  'function' => 
  array (
  ),
...
<div id="main">
	...
	<?php if (in_array('products',$_smarty_tpl->getVariable('manager')->value->permissions)){?>
		<li><a href="index.php?module=ProductsAdmin"><img src="design/images/menu/catalog.png"><b>Каталог</b></a></li>
	<?php }elseif(in_array('categories',$_smarty_tpl->getVariable('manager')->value->permissions)){?>
		<li><a href="index.php?module=CategoriesAdmin"><img src="design/images/menu/catalog.png"><b>Каталог</b></a></li>
	<?php }elseif(in_array('brands',$_smarty_tpl->getVariable('manager')->value->permissions)){?>
		<li><a href="index.php?module=BrandsAdmin"><img src="design/images/menu/catalog.png"><b>Каталог</b></a></li>
	<?php }elseif(in_array('features',$_smarty_tpl->getVariable('manager')->value->permissions)){?>
	...
	<!-- Подвал сайта -->
	<div id="footer">
	&copy; 2014 <a href='http://simplacms.ru'>Simpla <?php echo $_smarty_tpl->getVariable('config')->value->version;?>
</a>
	<?php if (in_array('license',$_smarty_tpl->getVariable('manager')->value->permissions)){?>
...
<?php if (!$_smarty_tpl->tpl_vars['d']->last){?>, <?php }?><?php }} ?>.
		...
		<?php }?>
	<?php }?>
	Вы вошли как <?php echo $_smarty_tpl->getVariable('manager')->value->login;?>
.
	<a href='<?php echo $_smarty_tpl->getVariable('config')->value->root_url;?>
...
<?php if ($_smarty_tpl->getVariable('settings')->value->pz_server&&$_smarty_tpl->getVariable('settings')->value->pz_phones[$_smarty_tpl->getVariable('manager')->value->login]){?>
<script src="design/js/prostiezvonki/prostiezvonki.min.js"></script>
<script>
var pz_type = 'simpla';
var pz_password = '<?php echo $_smarty_tpl->getVariable('settings')->value->pz_password;?>
';
var pz_server = '<?php echo $_smarty_tpl->getVariable('settings')->value->pz_server;?>
';
var pz_phone = '<?php echo $_smarty_tpl->getVariable('settings')->value->pz_phones[$_smarty_tpl->getVariable('manager')->value->login];?>
';
