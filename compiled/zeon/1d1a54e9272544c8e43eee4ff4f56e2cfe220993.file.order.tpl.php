<?php /* Smarty version Smarty-3.0.7, created on 2018-02-07 21:05:22
         compiled from "C:\Server\OSPanel\domains\slepopuzik//design/zeon/html\order.tpl" */ ?>
<?php /*%%SmartyHeaderCode:114265a7b3fe2947f80-67540243%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d1a54e9272544c8e43eee4ff4f56e2cfe220993' => 
    array (
      0 => 'C:\\Server\\OSPanel\\domains\\slepopuzik//design/zeon/html\\order.tpl',
      1 => 1517880752,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '114265a7b3fe2947f80-67540243',
  'function' => 
  array (
  ),
...
<div class="site-title"><div class="site-inside"><span>Детали заказа</span></div></div> 
...
<form method="post">
<div class="site-title"><div class="site-inside"><span>Выберите способ оплаты</span></div></div> 
<ul id="deliveries">
...
<input type='submit' class="button-4" value='Закончить заказ'>
</form>
<?php }elseif($_smarty_tpl->getVariable('payment_method')->value){?>
<div class="site-title"><div class="site-inside"><span>Способ оплаты &mdash; <?php echo $_smarty_tpl->getVariable('payment_method')->value->name;?>
</span></div></div> 
<form method=post><input type=submit class="button-4" name='reset_payment_method' value='Выбрать другой способ оплаты'></form>	

<p>
<?php echo $_smarty_tpl->getVariable('payment_method')->value->description;?>

</p>
<div class="site-title"><div class="site-inside"><span>
К оплате <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['convert'][0][0]->convert($_smarty_tpl->getVariable('order')->value->total_price,$_smarty_tpl->getVariable('payment_method')->value->currency_id);?>
&nbsp;<?php echo $_smarty_tpl->getVariable('all_currencies')->value[$_smarty_tpl->getVariable('payment_method')->value->currency_id]->sign;?>
