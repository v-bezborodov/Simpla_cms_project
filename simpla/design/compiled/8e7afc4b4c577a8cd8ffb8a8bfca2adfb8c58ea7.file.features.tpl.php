<?php /* Smarty version Smarty-3.0.7, created on 2018-02-07 23:01:02
         compiled from "simpla/design/html\features.tpl" */ ?>
<?php /*%%SmartyHeaderCode:62485a7b5afe102722-78429223%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '62485a7b5afe102722-78429223',
  'function' => 
  array (
    'categories_tree' => 
    array (
...
<?php ob_start(); ?>
	...
	<?php if (in_array('brands',$_smarty_tpl->getVariable('manager')->value->permissions)){?><li><a href="index.php?module=BrandsAdmin">Бренды</a></li><?php }?>
...
<div id="right_menu">
	...
	<ul>
		...
		<li <?php if (!$_smarty_tpl->getVariable('category')->value->id){?>class="selected"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('category_id'=>null),$_smarty_tpl);?>
">Все категории</a></li>	
		<?php }?>
